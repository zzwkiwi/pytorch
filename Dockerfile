...
# install mambaforge
RUN cd /home ; wget "https://github.com/conda-forge/miniforge/releases/download/23.11.0-0/Mambaforge-Linux-x86_64.sh" ; bash Mambaforge-23.11.0-0-Linux-x86_64.sh
